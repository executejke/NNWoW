...
local vendor = {name = "Aldren Cordon", x = -5702, y = -3785, z = 323}
...
-- function set() Сделать функцию которая будет
...
function setTargets()
    ...
    if #objects > 0 then
        for _, v in ipairs(objects) do
            if nn.UnitName(v) == "Loch Crocolisk" then -- Фильтруем таблицу по нужным нам юнитам.
